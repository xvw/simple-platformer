...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "simple-platformer", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "Simple platformer";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "Simple platformer", null, { width: 720, height: 416 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 720, height: 416 });
			#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 720, 416, "null");
		#end
		#else
		create ();
		#end
